                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap">
                        ...
                        <p class="footer-about-us-desc">
                            Skill9 is a LMS platform that connect Teachers with Students globally. Teachers crate high quality course and present them in super easy way.
                        </p>
                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap contact-us-widget-wrap">
                        ...
                        <p class="footer-address">
                            SKILL9 Universal Academy, # 399, "SS Prime", Double Road, AGB Layout, Hesaraghatta Main Road, Bengaluru - 560090, Karnataka, India.
                        </p>

                        <p class="mb-0"> Tel: +91 8035893531/
                            +91 8035893532 </p>
                        <p class="mb-0">  info@skill9academy.com </p>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="footer-bottom-contents-wrap d-flex">
                        ...
                        <div class="footer-bottom-left d-flex">
                            <h5 class="text-warning">Skill9 LMS</h5>
                            <span class="ml-4">Copyright © 2023 Skill9. All rights reserved.</span>
                        </div>
