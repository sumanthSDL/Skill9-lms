            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        <img src="{{theme_url('images/website-design.png')}}">
                ...
                <div class="col-md-3">
                    <div class="home-info-box">
                        <img src="{{theme_url('images/webinar.png')}}">
    ...
    <div class="home-section-wrap home-cta-wrapper py-5 ">
        ...
        <div class="home-partners-logo-section pb-5 mb-5 text-center">
            <div class="container">
                ...
                <h5 class="home-partners-title mb-5">Companies use Skill9 to enrich their brand & business.</h5>
            ...
            <div class="row">
                <div class="col-sm-6 home-cta-left-col">
                    ...
                    <div class="home-cta-text-wrapper px-5 text-center">
                        ...
                        <p>Spread your knowledge to millions of students around the world through Skill9 teaching platform. You can teach any tech you love from heart.
                        </p>
